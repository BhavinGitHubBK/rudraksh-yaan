            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <!-- <span class="db"><img src="assets/img/logo2.svg" alt="logo" /></span> -->
                        <h2>Welcome back - Admin Login</h2>
                    </div>
                    <!-- Form -->
                            ...
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success text-white" id="basic-addon1"><i class="la flaticon-user-1"></i></span>
                                    </div>
